  ...
  <div class="govuk-width-container">
    <div class="content">
      ...
      <div class="forum">
        ...
        <Profile :isLinkActive="false" :isFullRoute="true" v-if="isTopics" />
        <Rules v-else />
      </div>
    </div>
  </div>
