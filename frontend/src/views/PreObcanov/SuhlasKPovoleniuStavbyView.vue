<template>
  <div class="govuk-width-container">
    <div class="content w-75">
      ...
      <p>
        V zmysle § 17 ods. 1, písm. a) zákona č. 137/2010 Z.z. o ovzduší je
        potrebný súhlas orgánu ochrany ovzdušia k povolenie stavby malého zdroja
      ...
      <ul>
        <li>žiadosť</li>
        <li>projektová dokumentácia</li>
        <li>situácia stavby a PD (časť vykurovanie a architektúra)</li>
...
export default {
  name: "SuhlasKPovoleniuStavbyView",
  data() {
    return {
      files: [
        {
          name: "Vydanie súhlasu k povoleniu stavby malého zdroja znečisťovania ovzdušia - žiadosť",
          size: "93.56 kB",
          ext: "PDF",
          urlFile: "/",
        },
