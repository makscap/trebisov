    ...
    <div data-module="idsk-intro-block">
      <div class="idsk-intro-block">
        <div class="govuk-grid-row">
          ...
          >
            <h2 class="govuk-heading-m">Vitajte na MIRRI SR</h2>
            <p class="govuk-body">
              Dozvedieť sa
              <a class="govuk-link" href="#" title="viac o ministerstve"
                >viac o ministerstve</a
              >.
            </p>
            <div
            ...
            <div>
              <ul class="idsk-intro-block__list__ul">
                ...
                <li class="idsk-intro-block__list__li">
                  <a
                    class="govuk-link idsk-intro-block__list__a"
                    href="#"
                    title="Eurofondy"
                  >
                    Eurofondy
          ...
          >
            <h2 class="govuk-heading-s">Populárny obsah</h2>
